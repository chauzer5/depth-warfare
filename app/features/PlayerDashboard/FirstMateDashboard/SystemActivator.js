...
export default function SystemActivator(props) {
  ...
  const { systemChargeLevels, pendingNavigate, pendingSystemCharge } =
    networkState;
  ...
  return (
    <div style={styles.main}>
      ...
      <div
        style={clickable ? styles.clickableCircle : styles.circle}
      ...
      <SystemChargeMeter
        ...
        showPendingCharge={pendingSystemCharge[playerTeam] === system.name}
      />
    </div>
  );
}
