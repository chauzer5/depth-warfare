...
export default function TriangleShiftButton(props){
    ...
    switch(direction){
        case "north":
            ...
            break;
        case "south":
            if(radioMapNotes.find(note => note[0] === process.env.MAP_DIMENSION - 1)){
                disabled = true;
            }
            break;
        case "west":
            ...
            break;
        case "east":
            if(radioMapNotes.find(note => note[1] === process.env.MAP_DIMENSION - 1)){
                disabled = true;
            }
            break;
        default:
    ...
    const keyName = direction === "north" ? "ArrowUp" :
